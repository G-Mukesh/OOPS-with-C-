...
class Programmer : public Employee{
	private:
		int bp;
	public:
		Programmer(string name,int id,string address,string mailid,int phno,int bp):Employee(empname,empid,address,mailid,phno),bp(bp){}
		
		
		void display(){
			double da=(97.0/100)*bp;
			double hra=(1.0/10)*bp;
			double pf=(12.0/100)*bp;
			double scf=(1.0/1000)*bp;
...
class Assistant_Proffessor : public Employee{
	private:
		int bp;
	public:
		Assistant_Proffessor(string name,int id,string address,string mailid,int phno,int bp):Employee(empname,empid,address,mailid,phno),bp(bp){}
...
class Associate_Professor : public Employee{
	private:
		int bp;
	public:
		Associate_Professor(string name,int id,string address,string mailid,int phno,int bp):Employee(empname,empid,address,mailid,phno),bp(bp){}
...
class Professor : public Employee{
	private:
		int bp;
	public:
		Professor(string name,int id,string address,string mailid,int phno,int bp):Employee(empname,empid,address,mailid,phno),bp(bp){}
...
int main(){
	...
	if(n==0){
		...
		Assistant_Proffessor AP(name,id,address,mailid,phno,bp);
		AP.display();
